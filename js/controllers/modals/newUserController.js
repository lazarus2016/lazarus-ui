...
angular.module('lazarusApp').controller('newUserController', ["$scope", "$http", "newUser", "userService", "$state", "viewFactory", 'gettextCatalog', function ($scope, $http, newUser, userService, $state, viewFactory, gettextCatalog) {
    ...
    $scope.savePassToFile = function (pass) {
        ...
        FS.saveAs(blob, "LazarusPassphrase.txt");
    }
