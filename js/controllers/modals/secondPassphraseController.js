...
angular.module('lazarusApp').controller('secondPassphraseModalController', ["$scope", "secondPassphraseModal", "$http", "userService", "feeService", function ($scope, secondPassphraseModal, $http, userService, feeService) {
    ...
    $scope.savePassToFile = function (pass) {
        ...
        FS.saveAs(blob, "LazarusSecondPassphrase.txt");
    }
